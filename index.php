...
<form action="index.php" method="post" name="myForm">
    ...
    <script> 
      ...
      {
        location.href="index.php?Type=0";
      }
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="slide-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="250ms"><a href="single-post.html">看電影是一種享受，一種生活，<br>一種娛樂。</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="blog-wrapper section-padding-100 clearfix">
        <div class="container">
            ...
            if($Type==0)
            {
                $sql0 = "SELECT * from movie where release_date<=CURDATE() Limit 6";
                $result = $db_link->query($sql0);
            }
            if($Type==1)
            {
                $sql1 = "SELECT * from movie where release_date>CURDATE() Limit 6";
			...
			<div class="row align-items-end">
                ...
                </div><!--End of col-12 col-md-6 col-lg-4-->		   		   
		        <?php }?> 
            </div>
            
            <button type="submit" class="btn original-btn" onclick="location.href='MovieList.php?Type=<?php echo $Type?>'">更多電影</button>
