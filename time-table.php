...
<head>
    ...
    <!-- Title -->
    <title>StarMovie - TimeTable</title>
    ...
    <div class="single-blog-wrapper section-padding-0-100">
        ...
        <div class="single-blog-area blog-style-2 mb-50">
            <div class="single-blog-thumbnail">
                <img src="img/bg-img/timetableBG.jpg" alt="">
                ...
                <div class="col-12 col-lg-9" >
                    ...
                    <div class="single-blog-area blog-style-2 mb-50">
                        ...
                        <div class="single-blog-content">
                            <div class="line"></div>
                            <a href="#" class="post-tag">時刻表</a>
                        </div>
                    </div>
                    <?php
                    require_once("connMysql.php");
                    $sqlA="SELECT * FROM theater AS a JOIN timetable AS b JOIN movie AS c ON a.t_id = b.theater_id AND b.movie_id=$id AND c.movie_id=$id";
                    ...
                    <div class="blog-post-author d-flex" >
                        <div class="author-thumbnail" >
                            <img src="img/movie/<?php echo "$row->photo";?>" alt="">
                        </div>
                        <div class="author-info">
                            <div class="line"></div>
                            <!-- <span class="author-role">Author</span> -->
                            <h4><a class="author-name"><?php echo "$row->t_name";?></a></h4>
                            <span class="author-role"><?php echo "$row->movie_name";?></span>
                            <div style="border 1px solid" >
                            <ul class="no-bullet seat-list"><li data-open="go-ticket" aria-controls="go-ticket" aria-haspopup="true" tabindex="0" ><h6><?php echo "$row->t_time";?></h6><p><span class="float-left info"><?php echo"$row->auditorium";?>廳</span></p></li></ul>                                       </div>
                        </div>
                    </div>
                    <?php } ?>              
                </div>
